...
Yakin mau hapus?", [ [ { text: "✅ YA, HAPUS", callback_data: "admin:payment:setting:clear:confirm:${field}", }, ], [ { text: "❌ BATAL", callback_data: "admin:payment:setting:${field}`,
},
],
]
);
...
await supabase(
env,
"orders?payment_id=eq.${encodeURIComponent( transactionId )}&status=eq.PENDING",
"PATCH",
{
status:
"PAID",
...
await supabase(
env,
"orders?id=eq.${Number( order.id )}&status=eq.PENDING",
"PATCH",
{
status:
"PAID",
